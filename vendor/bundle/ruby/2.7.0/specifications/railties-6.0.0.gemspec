...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.0/railties/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.0/railties" } if s.respond_to? :metadata=
  ...
  s.add_runtime_dependency(%q<thor>.freeze, [">= 0.20.3".freeze, "< 2.0".freeze])
  s.add_runtime_dependency(%q<method_source>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<actionview>.freeze, ["= 6.0.0".freeze])
end

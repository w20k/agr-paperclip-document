...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<terrapin>.freeze, ["~> 0.6.0".freeze])
  s.add_runtime_dependency(%q<mime-types>.freeze, [">= 0".freeze])
  s.add_runtime_dependency(%q<mimemagic>.freeze, ["~> 0.3.0".freeze])
  s.add_development_dependency(%q<activerecord>.freeze, [">= 4.2.0".freeze])
  ...
  s.add_development_dependency(%q<cucumber-rails>.freeze, [">= 0".freeze])
  s.add_development_dependency(%q<cucumber-expressions>.freeze, ["= 4.0.3".freeze])
  s.add_development_dependency(%q<aruba>.freeze, ["~> 0.9.0".freeze])
  ...
  s.add_development_dependency(%q<launchy>.freeze, [">= 0".freeze])

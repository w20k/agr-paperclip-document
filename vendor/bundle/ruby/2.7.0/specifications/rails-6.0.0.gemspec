...
Gem::Specification.new do |s|
  ...
  s.add_runtime_dependency(%q<actionmailer>.freeze, ["= 6.0.0".freeze])
  s.add_runtime_dependency(%q<activejob>.freeze, ["= 6.0.0".freeze])
  s.add_runtime_dependency(%q<actioncable>.freeze, ["= 6.0.0".freeze])
  s.add_runtime_dependency(%q<activestorage>.freeze, ["= 6.0.0".freeze])
  s.add_runtime_dependency(%q<actionmailbox>.freeze, ["= 6.0.0".freeze])
  s.add_runtime_dependency(%q<actiontext>.freeze, ["= 6.0.0".freeze])

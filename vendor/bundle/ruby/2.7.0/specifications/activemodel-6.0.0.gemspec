# -*- encoding: utf-8 -*-
# stub: activemodel 6.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.0/activemodel/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.0/activemodel" } if s.respond_to? :metadata=

# -*- encoding: utf-8 -*-
# stub: actionview 6.0.0 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.0/actionview/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.0/actionview" } if s.respond_to? :metadata=
  ...
  s.add_development_dependency(%q<actionpack>.freeze, ["= 6.0.0".freeze])
  s.add_development_dependency(%q<activemodel>.freeze, ["= 6.0.0".freeze])
end

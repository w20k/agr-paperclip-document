...
Gem::Specification.new do |s|
  ...
  s.metadata = { "changelog_uri" => "https://github.com/rails/rails/blob/v6.0.0/activejob/CHANGELOG.md", "source_code_uri" => "https://github.com/rails/rails/tree/v6.0.0/activejob" } if s.respond_to? :metadata=
